...
import { convertToOptions, convertUTCToLocal, convertUTCToLocalDate } from '@/helpers';
  ...
  return (
    <div className='flex flex-row-reverse justify-between'>
      ...
      <div className='flex flex-col gap-y-5 w-1/2'>
        ...
        {appointment?.vehicle && ['superAdmin', 'admin', 'receptionist', 'worker'].some(role => permissions?.includes(role)) && (
          <RowDetail
            title='Vehicle'
        ...
        {appointment.scheduleDate && <RowDetail title='Schedule Date' value={convertUTCToLocalDate(appointment.scheduleDate)} />}
